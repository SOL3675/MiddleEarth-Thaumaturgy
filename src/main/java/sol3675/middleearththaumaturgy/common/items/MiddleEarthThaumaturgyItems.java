...
public class MiddleEarthThaumaturgyItems {
	...
	public static void addItems() {
		...
		WAND_ROD_HOBBIT = new WandRod("HOBBIT", 100, new ItemStack(wandCore, 1, 1), 12, new FactionWandUpdate(), new ResourceLocation("middleearththaumaturgy","textures/models/wand_rod_hobbit.png"));
		WAND_ROD_RANGER_NORTH = new WandRod("RANGER_NORTH", 100, new ItemStack(wandCore, 1, 2), 12, new FactionWandUpdate(), new ResourceLocation("middleearththaumaturgy","textures/models/wand_rod_ranger_north.png"));
		WAND_ROD_BLUE_MOUNTAINS = new WandRod("BLUE_MOUNTAINS", 100, new ItemStack(wandCore, 1, 3), 12, new FactionWandUpdate(), new ResourceLocation("middleearththaumaturgy","textures/models/wand_rod_blue_mountains.png"));
		WAND_ROD_HIGH_ELF = new WandRod("HIGH_ELF", 100, new ItemStack(wandCore, 1, 4), 12, new FactionWandUpdate(), new ResourceLocation("middleearththaumaturgy","textures/models/wand_rod_high_elf.png"));
		WAND_ROD_GUNDABAD = new WandRod("GUNDABAD", 100, new ItemStack(wandCore, 1, 5), 12, new FactionWandUpdate(), new ResourceLocation("middleearththaumaturgy","textures/models/wand_rod_gundabad.png"));
		WAND_ROD_ANGMAR = new WandRod("ANGMAR", 100, new ItemStack(wandCore, 1, 6), 12, new FactionWandUpdate(), new ResourceLocation("middleearththaumaturgy","textures/models/wand_rod_angmar.png"));
		WAND_ROD_WOOD_ELF = new WandRod("WOOD_ELF", 100, new ItemStack(wandCore, 1, 7), 12, new FactionWandUpdate(), new ResourceLocation("middleearththaumaturgy","textures/models/wand_rod_wood_elf.png"));
		WAND_ROD_DOL_GULDUR = new WandRod("DOL_GULDUR", 100, new ItemStack(wandCore, 1, 8), 12, new FactionWandUpdate(), new ResourceLocation("middleearththaumaturgy","textures/models/wand_rod_dol_guldur.png"));
		WAND_ROD_DALE = new WandRod("DALE", 100, new ItemStack(wandCore, 1, 9), 12, new FactionWandUpdate(), new ResourceLocation("middleearththaumaturgy","textures/models/wand_rod_dale.png"));
		WAND_ROD_DWARF = new WandRod("DWARF", 100, new ItemStack(wandCore, 1, 10), 12, new FactionWandUpdate(), new ResourceLocation("middleearththaumaturgy","textures/models/wand_rod_dwarf.png"));
		WAND_ROD_GALADHRIM = new WandRod("GALADHRIM", 100, new ItemStack(wandCore, 1, 11), 12, new FactionWandUpdate(), new ResourceLocation("middleearththaumaturgy","textures/models/wand_rod_galadhrim.png"));
		WAND_ROD_DUNLAND = new WandRod("DUNLAND", 100, new ItemStack(wandCore, 1, 12), 12, new FactionWandUpdate(), new ResourceLocation("middleearththaumaturgy","textures/models/wand_rod_dunland.png"));
		WAND_ROD_URUK_HAI = new WandRod("URUK_HAI", 100, new ItemStack(wandCore, 1, 13), 12, new FactionWandUpdate(), new ResourceLocation("middleearththaumaturgy","textures/models/wand_rod_uruk_hai.png"));
		WAND_ROD_FANGORN = new WandRod("FANGORN", 100, new ItemStack(wandCore, 1, 14), 12, new FactionWandUpdate(), new ResourceLocation("middleearththaumaturgy","textures/models/wand_rod_fangorn.png"));
		WAND_ROD_ROHAN = new WandRod("ROHAN", 100, new ItemStack(wandCore, 1, 15), 12, new FactionWandUpdate(), new ResourceLocation("middleearththaumaturgy","textures/models/wand_rod_rohan.png"));
		WAND_ROD_MORDOR = new WandRod("MORDOR", 100, new ItemStack(wandCore, 1, 16), 12, new FactionWandUpdate(), new ResourceLocation("middleearththaumaturgy","textures/models/wand_rod_mordor.png"));
		WAND_ROD_DORWINION = new WandRod("DORWINION", 100, new ItemStack(wandCore, 1, 17), 12, new FactionWandUpdate(), new ResourceLocation("middleearththaumaturgy","textures/models/wand_rod_dorwinion.png"));
		WAND_ROD_RHUN = new WandRod("RHUN", 100, new ItemStack(wandCore, 1, 18), 12, new FactionWandUpdate(), new ResourceLocation("middleearththaumaturgy","textures/models/wand_rod_rhun.png"));
		WAND_ROD_NEAR_HARAD = new WandRod("NEAR_HARAD", 100, new ItemStack(wandCore, 1, 19), 12, new FactionWandUpdate(), new ResourceLocation("middleearththaumaturgy","textures/models/wand_rod_near_harad.png"));
		WAND_ROD_MOREDAIN = new WandRod("MOREDAIN", 100, new ItemStack(wandCore, 1, 20), 12, new FactionWandUpdate(), new ResourceLocation("middleearththaumaturgy","textures/models/wand_rod_moredain.png"));
