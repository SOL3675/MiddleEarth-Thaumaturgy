...
public class MeetCfg {
	...
	public static int tcWarpWardPotionID = 33;
	...
	public static void configurate(File cfgfile) {
		...
		try {
			...
			tcWarpWardPotionID = cfg.get("general", "ThaumcraftWarpWardPotionID", tcWarpWardPotionID, "ID of Thaumcraft WarpWard Potion").getInt(tcWarpWardPotionID);
